# from https://www.datatechnotes.com/2019/12/multi-output-regression-example-with.html?m=1
# Shows how to use a 2D hstack out_dim to have it predict multiple values from the final layer of neurons
